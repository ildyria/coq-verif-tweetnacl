...
Lemma bounds_car_sup: forall i l, (length l = 16)%nat -> 0 <= ℤ16.lst l < 2^256 -> 
...
Lemma bounds_car_inf: forall i l, (length l = 16)%nat -> 0 <= ℤ16.lst l < 2^256 -> 0 <= nth i (car25519 l) 0.
Proof.
