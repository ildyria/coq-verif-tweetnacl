...
| 0,[] => []
| a,[] => [a]
| a,h :: q => getResidute n (a + h) :: Carrying (getCarry n (a + h)) q
end.
...
Lemma Carry_n_step: forall m a h q, Carrying_n (S m) a (h :: q) = getResidute n (a + h) :: Carrying_n m (getCarry n (a + h)) q.
