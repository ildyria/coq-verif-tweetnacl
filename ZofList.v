...
assert(HS: 2^(n * ℤ.ℕ length (slice m (z::l))) * (ℤ.lst tail m (z :: l)) = 2^(n * ℤ.ℕ length (slice m (z::l))) * (ℤ.lst tail m (z :: l)) - (ℤ.lst slice m (z :: l)) + (ℤ.lst slice m (z :: l))) by omega.
rewrite HS ; clear HS.
