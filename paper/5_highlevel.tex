...
Points of an elliptic curve are equipped with the structure of an abelian group.
\begin{itemize}
  \item The negation of a point $P = (x,y)$ is defined by reflecting in the $x$ axis $-P = (x, -y)$.
...
We then define a bijection between a Montgomery curve and its Weierstra{\ss} form.
